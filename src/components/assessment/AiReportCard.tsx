  ...
  return (
    <View style={{ marginTop: '16px' }}>
      ...
      <View style={{ textAlign: 'center', padding: '8px 0 10px' }}>
        <Text style={{ fontSize: '13px', fontWeight: 700, color: '#162340', display: 'block', marginTop: '8px' }}>
          你的画像：{segmentLabel}
        </Text>
        ...
        {report.opportunities.map((opp, i) => {
          ...
          return (
            ...
            >
              ...
              >
                {opp.dimension} {opp.currentScore}→{opp.targetScore}
              </Text>
      ...
      <View style={card}>
        ...
        {report.roadmap && report.roadmap.length > 0 ? (
          ...
          >
            <Text style={{ fontSize: '13px', display: 'block', marginBottom: '6px', color: '#9298a8' }}>🔒</Text>
            <Text style={{
